#!/usr/bin/env python3
"""Validate Fork self-standing projection v0.1 without collapsing provenance or independence."""
...
TOP_KEYS = {
    ...
    "projection_nature", "append_only", "repository_coordinate",
...
EVIDENCE_KEYS = {"evidence_id", "kind", "relation", "source", "coordinate", "digest"}
