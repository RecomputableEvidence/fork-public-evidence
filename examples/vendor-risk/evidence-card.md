...
A downstream consumer attempted to treat the memo as broader vendor approval. Fork records that attempted expansion as a boundary issue rather than silently inheriting the broader claim.
